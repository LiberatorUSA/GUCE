...
#include "guceCEGUIOgre_ETypes.h"        /* simple types */
#define GUCE_CEGUIOGRE_ETYPES_H
#endif /* GUCE_CEGUIOGRE_ETYPES_H ? */

#ifndef GUCE_CEGUIOGRE_CONFIG_H
#include "guceCEGUIOgre_config.h"        /* Module build configuration */
...
#ifdef GUCE_CEGUIOGRE_BUILD_MODULE
  #define GUCE_EXPORTSPEC GUCE_EXPORT
#else
  #define GUCE_EXPORTSPEC GUCE_IMPORT
#endif /* GUCE_CEGUIOGRE_BUILD_MODULE ? */

#undef GUCE_CEGUIOGRE_EXPORT_CPP
#ifdef GUCE_CEGUIOGRE_EXPORT_CPP_CODE
  #define GUCE_CEGUIOGRE_EXPORT_CPP GUCE_EXPORTSPEC
#else
  #define GUCE_CEGUIOGRE_EXPORT_CPP
#endif /* GUCEF_GUI_EXPORT_CPP_CODE */

#undef GUCE_CEGUIOGRE_EXPORT_C
#ifdef GUCE_CEGUIOGRE_EXPORT_C_CODE
  #define GUCE_CEGUIOGRE_EXPORT_C GUCE_EXPORTSPEC
#else
  #define GUCE_CEGUIOGRE_EXPORT_C
#endif /* GUCE_CEGUIOGRE_EXPORT_C_CODE */
