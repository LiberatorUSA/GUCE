...
#ifndef GUCE_CEGUIOGRE_CCHECKBOXIMP_H
#define GUCE_CEGUIOGRE_CCHECKBOXIMP_H
...
class GUCE_CEGUIOGRE_EXPORT_CPP CCheckboxImp : public CWidgetImp< GUCEF::GUI::CCheckbox >
{
    public:
...
#endif /* GUCE_CEGUIOGRE_CCHECKBOXIMP_H ? */
