...
/*************************************************************************
	Constructor
*************************************************************************/
OgreCEGUIRenderer::OgreCEGUIRenderer(Ogre::RenderWindow* window, Ogre::uint8 queue_id, bool post_queue, CEGUI::uint max_quads)
{
...
*************************************************************************/
OgreCEGUIRenderer::OgreCEGUIRenderer(Ogre::RenderWindow* window, Ogre::uint8 queue_id, bool post_queue, CEGUI::uint max_quads, Ogre::SceneManager* scene_manager)
{
	constructor_impl(window, queue_id, post_queue, max_quads);
...
*************************************************************************/
void OgreCEGUIRenderer::addQuad(const CEGUI::Rect& dest_rect, float z, const CEGUI::Texture* tex, const CEGUI::Rect& texture_rect, const CEGUI::ColourRect& colours, CEGUI::QuadSplitMode quad_split_mode)
{
	...
	else
	{
		...
		quad.position.offset(CEGUI::Point(-1.0f, -1.0f));
...
*************************************************************************/
CEGUI::Texture* OgreCEGUIRenderer::createTexture(void)
{
...
*************************************************************************/
CEGUI::Texture* OgreCEGUIRenderer::createTexture(const CEGUI::String& filename, const CEGUI::String& resourceGroup)
{
...
*************************************************************************/
CEGUI::Texture* OgreCEGUIRenderer::createTexture(float size)
{
	OgreCEGUITexture* tex = (OgreCEGUITexture*)createTexture();
	tex->setOgreTextureSize((CEGUI::uint)size);
...
*************************************************************************/
void OgreCEGUIRenderer::destroyTexture(CEGUI::Texture* texture)
{
	if (texture != NULL)
	{
...
*************************************************************************/
void OgreCEGUIRenderer::renderQuadDirect(const CEGUI::Rect& dest_rect, float z, const CEGUI::Texture* tex, const CEGUI::Rect& texture_rect, const CEGUI::ColourRect& colours, CEGUI::QuadSplitMode quad_split_mode)
{
	if (d_render_sys->_getViewport()->getOverlaysEnabled())
	{
		z = -1 + z;

		CEGUI::Rect final_rect;
		...
		final_rect.offset(CEGUI::Point(-1.0f, -1.0f));

		// convert colours for ogre, note that top / bottom are switched.
        CEGUI::uint32 topLeftCol	= colourToOgre(colours.d_bottom_left);
        CEGUI::uint32 topRightCol	= colourToOgre(colours.d_bottom_right);
        CEGUI::uint32 bottomLeftCol	= colourToOgre(colours.d_top_left);
        CEGUI::uint32 bottomRightCol= colourToOgre(colours.d_top_right);
...
/*************************************************************************
	...
	expecting.	
*************************************************************************/
CEGUI::uint32 OgreCEGUIRenderer::colourToOgre(const CEGUI::colour& col) const
{
...
*************************************************************************/
void OgreCEGUIRenderer::constructor_impl(Ogre::RenderWindow* window, CEGUI::uint8 queue_id, bool post_queue, CEGUI::uint max_quads)
{
	...
	d_bufferPos		= 0;
	d_sorted		= true;
	d_ogre_root		= Ogre::Root::getSingletonPtr();
	d_render_sys	= d_ogre_root->getRenderSystem();
    // set ID string
    d_identifierString = "CEGUI::OgreRenderer for GUCE";
	...
	d_texelOffset = CEGUI::Point((float)d_render_sys->getHorizontalTexelOffset(), -(float)d_render_sys->getVerticalTexelOffset());
...
*************************************************************************/
CEGUI::Texture* OgreCEGUIRenderer::createTexture(Ogre::TexturePtr& texture)
{
...
*************************************************************************/
CEGUI::ResourceProvider* OgreCEGUIRenderer::createResourceProvider(void)
{
...
*************************************************************************/
void OgreCEGUIRenderer::setDisplaySize(const CEGUI::Size& sz)
{
