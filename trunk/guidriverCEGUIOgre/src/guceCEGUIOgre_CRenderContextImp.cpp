...
#include "guceCEGUIOgre_OgreCEGUITexture.h"
...
{GUCE_TRACE;
    ...
    delete static_cast< OgreCEGUITexture* >( m_renderTexture );
...
{GUCE_TRACE;
    ...
    {       
        ...
        m_renderTexture = CGUIDriver::Instance()->GetRenderer()->createTexture( (CEGUI::utf8*) ogreRenderTexture->getName().c_str(), "GUI" );
