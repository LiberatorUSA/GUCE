...
#ifndef GUCE_CEGUIOGRE_CVFSINFOPROVIDER_H
#define GUCE_CEGUIOGRE_CVFSINFOPROVIDER_H
 ...
 */
class GUCE_CEGUIOGRE_EXPORT_CPP CVFSInfoProvider : public GUCEF::GUI::CIFileSystemInfoProvider
{
    public:
...
#endif /* GUCE_CEGUIOGRE_CVFSINFOPROVIDER_H ? */
