...
#define GUCE_CEGUIOGRE_CGUIFILESYSTEMDIALOGIMP_H
#endif /* GUCE_CEGUIOGRE_CGUIFILESYSTEMDIALOGIMP_H ? */
...
/**
 *  Specializes the generic file system dialog for file open operations
 */
class GUCE_CEGUIOGRE_EXPORT_CPP CFileOpenDialogImp : public CFileSystemDialogImp
{
    public:
    
    CFileOpenDialogImp( void );
    
    virtual ~CFileOpenDialogImp();
